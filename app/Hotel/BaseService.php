<?php
/**
 * Base service class for handling database operations using PDO.
 *
 * This class serves as the superclass for other classes in the application.
 */
    ...
    protected function initializePdo()
    {
        ...
        try {
            self::$pdo = new PDO(sprintf('mysql:host=%s;dbname=%s;charset=UTF8', $databaseConfig['host'], 
                $databaseConfig['dbname']), $databaseConfig['username'], $databaseConfig['password'], [PDO::
